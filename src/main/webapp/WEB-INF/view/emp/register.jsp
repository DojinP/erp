		...
		$("#id").on("keyup", function(){
			...
			$.ajax({
				...
				success: function(data) {
					/* data => 서버와의 통신이 성공하면 자동으로 서버에서 넘겨주는 데이터
		...
		<form class="form-horizontal" action="/erp/emp/insert.do"
			...
			<fieldset>
				...
				<div class="form-group" style="padding: 40px">
					<p class="centered">
						<img src="/erp/images/${user.profile_photo}" id="profileImage"	style="width: 100px"/>
					</p>
					<div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="deptno" class="form-control" id="deptlist">
